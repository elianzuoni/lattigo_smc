...
// init registers the protocol to the underlying onet library
func init() {
...
// TODO: what about the non-roots? Who calls Init on them?
...
// Init does the rest of the initialisation, that could not be done in the "constructor"
// called by onet (NewEncryptionToSharesProtocol) because it didn't have the arguments.
// Needs to be called "manually" before starting.
